/**
 * Cartellino Info and Header Component
 * Handles the top action bar, cartellino details, piece photo management, and print modal.
 */
...
export function renderCartellinoHeader(cartellino) {
  return `
...
export function renderCartellinoInfo(cartellino) {
  ...
  return `
    ...
    <div class="data-table-card" style="padding: 20px; margin-bottom: 24px;">
      <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 20px;">
        ...
        <!-- Miniatura Foto Pezzo (16:9 - 356x200) -->
...
export function initCartellinoInfo(container, cartellinoId, rerender, cartellino, dipendentiMap, macchineMap) {
  ...
  if (printBtn) {
    printBtn.addEventListener('click', async () => {
      let cart = cartellino;
      let dipsMap = dipendentiMap;
      let macchsMap = macchineMap;
...
export function showCartellinoPrintModal(cartellino, dipendentiMap, macchineMap) {
